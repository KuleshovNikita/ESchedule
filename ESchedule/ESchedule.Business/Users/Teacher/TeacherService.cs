...
namespace ESchedule.Business.Users.Teacher
{
    public class TeacherService : ITeacherService
    {
        ...
        public TeacherService(IMapper mapper, IPasswordHasher passwordHasher, ITeacherRepository repository)
        {
            _mapper = mapper;
        ...
        public async Task<ServiceResult<Empty>> AddTeacher(TeacherModel userModel)
        {
        ...
        public async Task<ServiceResult<Empty>> RemoveTeacher(Guid userId)
        {
            var serviceResult = new ServiceResult<Empty>();

            if (await UserExists(userId))
            {
                var userModel = await GetTeacher(x => x.Id == userId);
        ...
        public async Task<ServiceResult<TeacherModel>> GetTeacher(Expression<Func<TeacherModel, bool>> predicate)
        {
        ...
        public async Task<ServiceResult<Empty>> UpdateTeacher(UserUpdateRequestModel userModel, Guid userId)
        {
            userModel.Id = userId;
            var user = await GetTeacher(x => x.Id == userModel.Id);
