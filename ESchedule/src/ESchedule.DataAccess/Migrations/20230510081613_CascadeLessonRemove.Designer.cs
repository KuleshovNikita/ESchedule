...
namespace ESchedule.DataAccess.Migrations
{
    ...
    [Migration("20230510081613_CascadeLessonRemove")]
    partial class CascadeLessonRemove
    {
            ...
            modelBuilder.Entity("ESchedule.Domain.Users.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Mykyta",
                            Password = "mpbgEWFnRU/LZTkVuBpFa/erUQnN6hZ0q4LfDrmzLl0Kwpzi",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta2",
                            Password = "NO1pdnwBZJZgSwcrQxp3oAbP/6J1dCe4apLsePyc4QmBdu0D",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta3",
                            Password = "updXx21ZOCy74EyzyGir9B8jq294kIXdlaaT61Rl41NYDz2n",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta4",
                            Password = "gGUAJiTK20FiIqoL+qXsiYnzw4iXJvpmTyBWc3KVSQBnfhH7",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher1",
                            Password = "DxTm0Lp3fW4Vnhor55ml2chYXnO2eCPoDfIpkIxYncdSoBiK",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher2",
                            Password = "JDPNsKgOUQRuZtDkM1kSBGjYlFvJZDgFa3EeVHvuHzqSf6bf",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher3",
                            Password = "RHNKXZ5iTWEGo0RNR1LQkG5z7Eaw2zoWL5SI2h5be5Ri501s",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
