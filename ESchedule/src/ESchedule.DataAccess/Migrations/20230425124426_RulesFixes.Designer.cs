...
namespace ESchedule.DataAccess.Migrations
{
    ...
    [Migration("20230425124426_RulesFixes")]
    partial class RulesFixes
    {
            ...
            modelBuilder.Entity("ESchedule.Domain.Users.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Mykyta",
                            Password = "2vn/dQqVmtXQ/j19M/qkIJp0mmF0qKe3d5PadfLSL2FXe8/X",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta2",
                            Password = "d5+RxcOM3fxNo5mIKUdU8B4Kvp9hZhW3hcgR8My1pqg8aSDp",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta3",
                            Password = "7eIn7uY0q1dFMjvZ47883mCtAHo1DX/3gc5mCDLBF9hIhyxT",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta4",
                            Password = "HiyxuaPxtoulxaMZUnlND1DCkw22XQoAt0WhPV1IKrk1/zhF",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher1",
                            Password = "87GBOqsiuzIC4prkUQEdPnmNQioNeZLhmAxkJUq/01fbX2/L",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher2",
                            Password = "byV6D9LM+/zLGJ0vAvO1LxZot9nrYEe6JqlDw3C6Jw3V8pwy",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher3",
                            Password = "h9p46uHoopPYE7rKQlL/uT8MUnchw03cYI+LANnk/+PIO6Iq",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
