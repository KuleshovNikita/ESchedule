...
namespace ESchedule.DataAccess.Migrations
{
    ...
    [Migration("20230625100711_fixDB2")]
            ...
            modelBuilder.Entity("ESchedule.Domain.Users.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Mykyta",
                            Password = "KPixd9BjDhFtv3okqX9D+K5/QJT/3crEe2McTX7lzpR3Lfr4",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta2",
                            Password = "wXDAIB4D9Jvgwui8Zn/kuwdw9KQmDJ6dITsXwi/d3cSEY5xM",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta3",
                            Password = "7NxSMg9r5q7AZgLMBEYlt8y1ID1PMbCK9qMVM2t+AsmWpsNy",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Mykyta4",
                            Password = "CEq+9JOJseAQJx466qZuvuPOiMNiqUGktgHeUllhFLAcH0mu",
                            Role = 0,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher1",
                            Password = "71HQPJ29FFNssBpvu119FzTU9ClJaQ8+XzWKifftTzg9q94o",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher2",
                            Password = "35qvlq4VpjXB9WD6aC7AZ3vzJ2fpbiJAvzi6zVj2xlI8PRTS",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        },
                        new
                        {
                            ...
                            Name = "Teacher3",
                            Password = "hCRh8YnsL3QeWNwa6gSrxGYDxaOAMH2pz0yTVTzSkid6sX3S",
                            Role = 1,
                            TenantId = new Guid("00000000-0000-0000-0000-000000000001")
                        });
                });
